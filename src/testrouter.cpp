...
TEST(MapRouter,FastestPathTest){
    ...
    //EXPECT_EQ(MapRouter.FindFastestPath(2, 6, Path), 31.343928);
    //EXPECT_EQ(MapRouter.FindFastestPath(3, 5, Path), 5.528612);
    //EXPECT_EQ(MapRouter.FindFastestPath(5, 2, Path), 23.0376);
